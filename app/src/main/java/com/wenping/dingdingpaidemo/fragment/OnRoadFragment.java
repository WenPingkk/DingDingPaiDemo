...
public class OnRoadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.fragment_onroad, null);
        initView(view);
        return view;
    }
    ...
    protected void initDatas() {
        if (mInfos.size() ==0) {
            ...
            mInfos.add(new PagerInfo("广场", SquareFragment.class, bundle));
            mInfos.add(new PagerInfo("动态", DynamicNewsFragment.class, bundle));
            mInfos.add(new PagerInfo("最新", LatestFragment.class, bundle));
        }
